...
class TrendSignalProvider(Protocol):
    ...
    def get_trend_score(self, title: str, keywords: list[str], manual_score: float | None = None) -> float:
        ...
...
class HistoricalPerformanceProvider(Protocol):
    ...
    def get_performance_score(self, topic_title: str, keywords: list[str], manual_score: float | None = None) -> float:
        ...
...
class RevenuePotentialProvider(Protocol):
    ...
    def get_revenue_score(self, niche: str, keywords: list[str], manual_score: float | None = None) -> float:
        ...
