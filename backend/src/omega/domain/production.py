...
class MotionEffect(enum.StrEnum):
    """Deterministic 2D motion effects."""
...
class NarrationQuality(enum.StrEnum):
    """Quality level of synthesized narration audio."""

    NEURAL_PRODUCTION = "NEURAL_PRODUCTION"
...
class ProductionQARuleCode(enum.StrEnum):
    """Authoritative rule codes for local Production Engine QA."""
    ...
    MISSING_REQUIRED_VISUAL_ATTRIBUTION = "MISSING_REQUIRED_VISUAL_ATTRIBUTION"
    ...
    SILENT_AUDIO_STREAM = "SILENT_AUDIO_STREAM"
    PLACEHOLDER_ONLY_VISUALS = "PLACEHOLDER_ONLY_VISUALS"
    MISSING_SUBTITLE_RENDER = "MISSING_SUBTITLE_RENDER"
    NO_CONTENTFUL_VISUAL_ASSET = "NO_CONTENTFUL_VISUAL_ASSET"
    DURATION_BELOW_DNA_MINIMUM = "DURATION_BELOW_DNA_MINIMUM"
    DURATION_TOO_SHORT = "DURATION_TOO_SHORT"
    ROBOTIC_FALLBACK_TTS = "ROBOTIC_FALLBACK_TTS"
    SUBTITLE_OCCLUSION_RISK = "SUBTITLE_OCCLUSION_RISK"
    SUBTITLE_TOO_LARGE = "SUBTITLE_TOO_LARGE"
    VISUAL_REPETITION = "VISUAL_REPETITION"
    EXCESSIVE_STATIC_SCENES = "EXCESSIVE_STATIC_SCENES"
    NO_MOTION = "NO_MOTION"
    MISSING_INTRO = "MISSING_INTRO"
    MISSING_OUTRO = "MISSING_OUTRO"
    INSUFFICIENT_BODY_DEPTH = "INSUFFICIENT_BODY_DEPTH"
    AUDIO_LOUDNESS_OUT_OF_RANGE = "AUDIO_LOUDNESS_OUT_OF_RANGE"
