...
import { getSystemInfo, getSystemStatus, type SystemInfo, type SystemStatus } from "@/lib/api";
...
export default function SettingsPage() {
  ...
  useEffect(() => { void Promise.allSettled([getSystemInfo(), getSystemStatus()]).then(([info, status]) => {
  ...
  return <div className="ui-page-stack settings-page">
    ...
    <div className="settings-shell">
      ...
      <section className="settings-content">
        ...
        {activeSection === "providers" && <Unsupported eyebrow="AI & PROVIDERS" title="Provider configuration" message="Provider names, credentials, and live availability are not exposed to this frontend. No connection claims or editable controls are shown." />}
